...
const ServiceCard = () => {
    return (
        <div className="bg-white rounded-4xl p-8 shadow-sm relative overflow-hidden h-80">
            {/* Background Pattern */}
            <div className="absolute inset-2 left-0 opacity-100">
                <img
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
                <div className='flex gap-3'>
                    <h2 className="text-5xl font-medium text-black mb-3">Services I</h2>
                    <h3 className="text-5xl font-light text-gray-400">offer</h3>
                </div>
